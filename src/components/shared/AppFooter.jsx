					...
					<ul className="flex gap-4 sm:gap-8">
						{socialLinks.map((link) => (
							<a
								...
								target="__blank"
								key={link.id}
								className="text-gray-400 hover:text-indigo-500 dark:hover:text-indigo-400 cursor-pointer rounded-lg bg-gray-50 dark:bg-ternary-dark hover:bg-gray-100 shadow-sm picon duration-300"
							>
